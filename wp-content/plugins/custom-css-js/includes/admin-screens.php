...
class CustomCSSandJS_Admin
{
    ...
    function add_new_buttons()
    {
        ...
        <div class="updated buttons">
            <a href="post-new.php?post_type=custom-css-js&language=css" class="custom-btn custom-css-btn">Add CSS
                code</a>
            <a href="post-new.php?post_type=custom-css-js&language=js" class="custom-btn custom-js-btn">Add JS code</a>
            <a href="post-new.php?post_type=custom-css-js&language=html" class="custom-btn custom-js-btn">Add HTML
                code</a>
...
End of comment */ ' . PHP_EOL . PHP_EOL;
        ...
        <form style="position: relative; margin-top: .5em;">
            ...
            <textarea class="wp-editor-area" id="content" mode="<?php echo htmlentities($code_mirror_mode); ?>"
                      name="content"><?php echo htmlentities($post->post_content); ?></textarea>

            <div class="code-mirror-after">
                <div><?php echo htmlentities($code_mirror_after); ?></div>
            </div>

            <input type="hidden" id="update-post_<?php echo $post->ID ?>"
                   value="<?php echo wp_create_nonce('update-post_' . $post->ID); ?>"/>
        </form>
    <?php
    ...
    function custom_code_options_meta_box_callback($post)
    {
        ...
        <div class="ccj_only_premium ccj_only_premium-right">
            <div>
                <a href="https://www.silkypress.com/simple-custom-css-js-pro/" target="_blank">Only available in Premium
                    version</a>
            </div>
        </div>
    ...
    function create_uploads_directory()
    {
        ...
        if (!file_exists($dir)) : ?>
            <div class="notice notice-error is-dismissible">
                ...
                <p>Please run the following commands in order to make the directory:
        ...
        if (!wp_is_writable($dir)) : ?>
            <div class="notice notice-error is-dismissible">
                <p>The <b><?php echo $dir; ?></b> directory is not writable, therefore the CSS and JS files cannot be
                    saved.</p>

                <p>Please run the following command to make the directory writable:<br/><strong>chmod
