...
class CustomCSSandJS_Addons
{
    ...
    function previews_meta_box_callback($post)
    {
        ...
        <div id="preview-action">
            <div>
                <input type="text" name="preview_url" id="ccj-preview_url"
                       placeholder="Full URL on which to preview the changes ..." disabled="disabled"/>
...
<?php
    ...
    function revisions_meta_box_callback($post)
    {
        ...
        <table class="revisions">
                ...
                <tr class="<?php echo $class; ?>" id="<?php echo 'revision-row-' . $revision['ID']; ?>">
                    ...
                    <td class="revisions-delete">
                        <input type="checkbox" name="delete[]"
                               value="<?php echo $revision['ID']; ?>" <?php echo $delete_disabled . $delete_tooltip; ?>/>
                    </td>
            ...
            <tr>
                <td>
                    <input type="button" class="button-secondary" value="<?php esc_attr_e('Compare'); ?>"
                           id="revisions-compare-button"/>
                </td>
                <td colspan="2"> &nbsp;</td>
                <td>
                    <input type="button" class="button-secondary" value="<?php esc_attr_e('Delete'); ?>"
                           id="revisions-delete-button"/>
                </td>
                <td> &nbsp; </td>
            </tr>
            </tbody>
